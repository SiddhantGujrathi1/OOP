...
#define max 100;
class per_info								//stud_info(student) is friend class of per_info
{
    ...
    per_info(const per_info &obj)     //COPY CONSTRUCTOR
    {
    lic=obj.lic;
    dob=obj.dob;
    bldgrp=obj.bldgrp;
...
class student   							//DEFINITION OF STUDENT CLASS
{
    ...
    {
        name="Gujrathi Siddhant";
        address="Lohar lane,Varchegaon,CHANDWAD";
        year="SE COMPUTER";
        div='A';
        roll_no=28;
        mob=9527458833;
